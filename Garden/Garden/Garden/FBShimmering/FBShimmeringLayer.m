...
- (void)_updateMaskColors
{
  ...
  UIColor *unmaskedColor = [UIColor colorWithWhite:1.0 alpha: _shimmeringAnimationOpacity];
    ...
    //_maskLayer.colors = @[(__bridge id)maskedColor.CGColor,  (__bridge id)maskedColor.CGColor, (__bridge id)unmaskedColor.CGColor, (__bridge id)maskedColor.CGColor,(__bridge id)maskedColor.CGColor];

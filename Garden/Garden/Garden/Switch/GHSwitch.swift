...
@IBDesignable
final class GHSwitch: UIControl {
    ...
    public var defaultSize:CGSize = CGSize(width: 45, height: 27)
    public var cornerRadius1: CGFloat = 1
    ...
    @IBInspectable  public var onTintColor: UIColor = UIColor(red: 0/255, green: 186/255, blue: 140/255, alpha: 1) {
        didSet {
            self.setupUI()
        }
    }
    
    @IBInspectable public var offTintColor: UIColor = UIColor(red: 223/255, green: 223/255, blue: 223/255, alpha: 1.0) {
        didSet {
            self.setupUI()
        }
    }
    ...
    @IBInspectable public var thumbSize: CGSize = CGSize(width: 23, height: 23) {
        didSet {
            self.layoutSubviews()
        }
    }
    ...
    // dodati kasnije
    @IBInspectable public var thumbShadowColor: UIColor = UIColor.clear {
        didSet {
    ...
    override init(frame: CGRect) {
        ...
        super.init(frame: CGRect(origin: frame.origin, size: CGSize(width: 47, height: 27)))
        self.setupUI()
    }
}
...
//    }
    ...
    public override func layoutSubviews() {
        ...
        if !self.isAnimating {
            self.frame = CGRect(origin: self.frame.origin, size: defaultSize)
